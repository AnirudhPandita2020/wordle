    ...
    return (
        <div className="w-full max-w-xl mx-auto p-6 border border-gray-200 rounded-xl shadow-sm mt-12">
            ...
            <div className="flex justify-center mt-8">
                <Button onClick={() => navigate("/game?mode=multi")}
                    className="text-sm px-5 py-2 rounded-md border border-gray-300 dark:bg-white dark:text-black text-white bg-black hover:bg-gray-50 transition">
                    ← Back to Game Lobby
                </Button>
            </div>
        </div>
            ...
            <div className="flex justify-center mb-4">
                <div className="flex gap-6 items-center px-6 py-3 rounded-xl shadow-sm
                    ...
                    <div className="text-sm font-medium text-gray-700 dark:text-gray-300">
                        🌀 Round: <span
                        className="font-semibold text-gray-900 dark:text-white">{game.players[sessionID].currentRound}</span> / {game.maxRounds}
                    </div>
